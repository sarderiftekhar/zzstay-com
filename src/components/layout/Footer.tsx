          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a
                ...
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:bg-accent-bright hover:text-white hover:border-accent-bright transition-all duration-300 hover:scale-110"
              >
                {social.icon}
              </a>
            ))}
